...
const DICT: Dict = {
  ...
  'cap.notFound': { id: 'Objek belum dapat diklasifikasikan.', en: 'Object could not be classified.' },
  'cap.notClassifiedHint': { id: 'Kami masih terus meningkatkan model pengenalan objek. Coba foto objek lain atau pindai dengan pencahayaan lebih terang.', en: 'We are still improving our object recognition model. Try another object or retake with brighter lighting.' },
